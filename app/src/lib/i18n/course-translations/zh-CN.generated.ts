      ...
      "module-getting-started": {
        ...
        "lessons": {
            ...
            "blocks": [
              {
                ...
                "questions": [
                  {
                    "id": "l1-q1",
                    "prompt": "What makes Solana state live “in 账户” rather than “inside contracts”?",
                    "options": [
                      "Programs are stateless logic 和 账户 data is passed explicitly to 指令",
                      "Programs persist mutable storage internally 和 only expose events",
                      "验证者 assign storage to whichever program has the most stake"
                    ],
                    "answerIndex": 0,
                    "explanation": "On Solana, mutable app state is 账户 data. Programs validate 和 mutate those 账户 but do not hold mutable state internally."
                  },
                  {
                    "id": "l1-q2",
                    "prompt": "Which fields make a 交易 valid to execute?",
                    "options": [
                      "Only program IDs 和 指令 data",
                      "Fee payer, recent blockhash, signatures, 和 指令",
                      "A 钱包 address 和 a memo string"
                    ],
                    "answerIndex": 1,
                    "explanation": "The runtime checks the message envelope 和 authorization: fee payer, freshness via blockhash, required signatures, 和 指令 payloads."
                  },
                  {
                    "id": "l1-q3",
                    "prompt": "Why does Solana care about read/write 账户 sets?",
                    "options": [
                      "To calculate NFT metadata size",
                      "To schedule non-conflicting 交易 in parallel safely",
                      "To compress signatures on mobile 钱包"
                    ],
                    "answerIndex": 1,
                    "explanation": "Read/write sets let the runtime detect conflicts 和 parallelize independent work deterministically."
                  }
                ]
              }
            ]
            ...
            "blocks": [
              ...
              },
              {
                ...
                "questions": [
                  {
                    "id": "l2-q1",
                    "prompt": "What does the `owner` field mean on an 账户?",
                    "options": [
                      "It is the user who paid the creation fee forever",
                      "It is the program authorized to modify 账户 data",
                      "It is always the same as fee payer in the last 交易"
                    ],
                    "answerIndex": 1,
                    "explanation": "Owner identifies the controlling program 用于 state mutation 和 many lamport operations."
                  },
                  {
                    "id": "l2-q2",
                    "prompt": "What does `executable: true` indicate?",
                    "options": [
                      "The 账户 can be used as 交易 fee payer",
                      "The 账户 stores runnable program bytecode",
                      "The 账户 can hold any SPL token mint directly"
                    ],
                    "answerIndex": 1,
                    "explanation": "Executable 账户 are code containers; they are not ordinary mutable data 账户."
                  },
                  {
                    "id": "l2-q3",
                    "prompt": "Why are token 账户 separate from 钱包 账户?",
                    "options": [
                      "钱包 账户 are too small to hold decimals",
                      "Token balances are program-specific state managed by the token program",
                      "Only 验证者 can read 钱包 balances"
                    ],
                    "answerIndex": 1,
                    "explanation": "SPL token state uses dedicated 账户 layouts 和 authorization rules enforced by the token program."
                  }
                ]
              }
            ]
                ...
                "steps": [
                  {
                    ...
                    "note": "Validate RPC URL 和 keypair path before sending 交易."
                  },
                  {
                    "cmd": "solana config set --url devnet",
                    "output": "Config File: ~/.config/solana/cli/config.yml\nRPC URL: https://api.devnet.solana.com",
                    "note": "Use devnet while learning to avoid accidental mainnet 交易."
                  },
                  {
                    "cmd": "solana address",
                  ...
                  },
                  {
                    ...
                    "note": "Pattern only; actual value depends on 钱包 funding."
                  }
                ]
              }
            ]
          ...
          "build-sol-transfer-transaction": {
            ...
            "duration": "35 min",
            "hints": [
              "Keep 交易 construction deterministic: no RPC or random values.",
              "Convert SOL to lamports using 1_000_000_000 multiplier.",
              "Mirror this logic in the real project helper in src/lib/课程/solana-fundamentals/project/walletManager.ts."
            ]
          }
        }
      },
        ...
        "lessons": {
            ...
            "blocks": [
              {
                ...
                "questions": [
                  {
                    "id": "l5-q1",
                    "prompt": "What makes a program 账户 executable?",
                    "options": [
                      "It has a 钱包 signature on every slot",
                      "Its 账户 metadata marks it executable 和 stores program bytecode",
                      "It owns at least one token 账户"
                    ],
                    "answerIndex": 1,
                    "explanation": "Executable 账户 are code containers 使用 runtime-recognized executable metadata."
                  },
                  {
                    "id": "l5-q2",
                    "prompt": "Why can’t a program discover arbitrary 账户 without them being passed in?",
                    "options": [
                      "Because 账户 dependencies must be explicit 用于 deterministic execution 和 lock scheduling",
                      "Because RPC nodes hide 账户 indexes from programs",
                      "Because only fee payers can list 账户"
                    ],
                    "answerIndex": 0,
                    "explanation": "账户 lists are part of the 指令 contract; hidden discovery would break determinism 和 scheduling assumptions."
                  },
                  {
                    "id": "l5-q3",
                    "prompt": "What is CPI?",
                    "options": [
                      ...
                      "A 验证者-level rent optimization flag"
                    ],
                    "answerIndex": 1,
                    "explanation": "跨程序调用 is core to Solana composability."
                  }
                ]
              }
            ]
                ...
                "questions": [
                  {
                    ...
                    "options": [
                      ...
                      "They avoid all 账户 rent costs",
                      "They replace 交易 signatures entirely"
                    ],
                    "answerIndex": 0,
                    "explanation": "PDAs provide deterministic program-controlled addresses 使用 no corresponding private key."
                  },
                  {
                    "id": "l6-q2",
                    "prompt": "Who signs 用于 a PDA in CPI flows?",
                    "options": [
                      "Any 钱包 holding SOL",
                      "The runtime on behalf of the program when invoke_signed seeds match",
                      "Only the fee payer of the outer 交易"
                    ],
                    "answerIndex": 1,
                    "explanation": "invoke_signed proves seed derivation to runtime, which grants PDA signer semantics 用于 that invocation."
                  },
                  {
                    "id": "l6-q3",
                ...
                "questions": [
                  {
                    ...
                    "options": [
                      "A deterministic token 账户 用于 a specific owner + mint pair",
                      "A 验证者 vote 账户 使用 token metadata",
                      "A compressed NFT ledger entry"
                    ],
                    "answerIndex": 0,
                    "explanation": "Associated Token 账户 standardize where fungible token balances are stored 用于 each owner/mint."
                  },
                  {
                    "id": "l7-q2",
                    "prompt": "Why is 钱包 address != token 账户?",
                    "options": [
                      "钱包 can only hold SOL while token balances are separate program-owned 账户",
                      "Token 账户 are deprecated 和 optional",
                      "钱包 addresses are private keys, token 账户 are public keys"
                    ],
                    "answerIndex": 0,
                    "explanation": "SPL balances are state in token 账户, not direct fields on 钱包 system 账户."
                  },
                  {
                    "id": "l7-q3",
                    ...
                    "options": [
                      ...
                      "Mint authority configured on the mint 账户",
                      "Any 账户 使用 enough lamports"
                    ],
                    "answerIndex": 1,
                    "explanation": "Mint authority is the explicit permission holder 用于 issuing additional supply."
                  }
                ]
              }
            ]
          ...
          "wallet-manager-cli-sim": {
            ...
            "hints": [
              ...
              "Use deterministic SOL-to-lamports conversion 使用 1_000_000_000 multiplier.",
        ...
        "lessons": {
                ...
                "questions": [
                  {
                    ...
                    "options": [
                      "IDL metadata, 账户 validation glue, 和 client-facing interface structure",
                      "验证者 hardware configuration 和 consensus votes",
                      "Automatic PDA funding from devnet faucets"
                    ],
                    "answerIndex": 0,
                    "explanation": "Anchor generates serialization/validation scaffolding 和 IDL contracts, not 验证者-level behavior."
                  },
                  {
                    "id": "anchor-l1-q2",
                    "prompt": "What is an IDL 和 who uses it?",
                    "options": [
                      ...
                      "A token mint extension required 用于 CPI"
                    ],
                    "answerIndex": 0,
                    "explanation": "IDL is interface metadata consumed by clients 和 tools to reduce 指令/账户 drift."
                  }
                ]
              }
            ]
            ...
            "blocks": [
              {
                ...
                "questions": [
                  {
                    "id": "anchor-l2-q1",
                    "prompt": "What does `#[账户(mut)]` signal to the runtime 和 framework?",
                    "options": [
                      "The 账户 may be written during execution 和 must be requested writable",
                      "The 账户 is owned by the system program",
                      "The 账户 is always a signer"
                    ],
                    "answerIndex": 0,
                    "explanation": "Mutability is part of 账户 metadata 和 lock planning, not a cosmetic annotation."
                  },
                  {
                    "id": "anchor-l2-q2",
                    "prompt": "What is a seeds constraint verifying?",
                    "options": [
                      "That the provided 账户 key matches deterministic PDA derivation rules",
                      "That the 账户 has maximum rent",
                      "That a token mint has 9 decimals"
                    ],
                    "answerIndex": 0,
                    "explanation": "Seeds + bump ensure deterministic 账户 identity 和 block 账户-substitution vectors."
                  }
                ]
              }
            ]
              ...
              },
              {
                ...
                "questions": [
                  ...
                  },
                  {
                    ...
                    "options": [
                      "You derive a different address 和 can orphan existing state",
          ...
          "anchor-counter-init-deterministic": {
            ...
            "hints": [
              ...
              "The init 指令 must include four keys in fixed order: counter PDA, authority, payer, system program.",
              "Encode 指令 data as [73,78,73,84,95,67,84,82,bump] so tests can compare exactly."
            ]
          }
        }
      },
        ...
        "lessons": {
          "anchor-increment-builder-and-emulator": {
            ...
            "hints": [
              ...
              "用于 this challenge, overflow should throw \"Counter overflow\" when count is 4294967295."
            ]
          },
            ...
            "blocks": [
              {
                ...
                "questions": [
                  {
                    "id": "anchor-l6-q1",
                    "prompt": "What belongs in deterministic unit tests 用于 Anchor clients?",
                    "options": [
                      "PDA derivation, 指令 bytes, 和 账户 key metadata",
                      "Devnet faucet reliability 和 slot timings",
                      "验证者 gossip propagation speed"
                    ],
                    "answerIndex": 0,
                    "explanation": "Deterministic unit tests should validate pure logic 和 serialization boundaries."
                  },
                  {
                    "id": "anchor-l6-q2",
                ...
                "questions": [
                  {
                    ...
                    "options": [
                      "Because 账户 constraints, owners, 和 指令 bytes can be invalid",
                      "Because the 钱包 signature always expires immediately",
                      "Because fee payer is irrelevant"
                    ],
                    "answerIndex": 0,
                    "explanation": "Simulation catches 账户 和 指令-level issues before final network commitment."
                  },
                  {
                    "id": "anchor-l7-q2",
                    "prompt": "What does fee payer mean in client 交易 UX?",
                    "options": [
                      "The 账户 funding 交易 fees/rent-sensitive operations",
                      "The 账户 that stores all token balances directly",
                      "The 账户 that sets RPC endpoint"
                    ],
                    "answerIndex": 0,
                    "explanation": "Fee payer funds execution costs 和 must have sufficient SOL."
                  }
                ]
              }
            ]
          ...
          "anchor-counter-project-checkpoint": {
            ...
            "hints": [
              ...
              "Use fixed key order 和 fixed JSON key order to satisfy strict expected output matching.",
              "The emulator sequence 用于 this checkpoint is init -> increment -> increment, so finalCount should be 2."
            ]
          }
        }
      }
        ...
        "lessons": {
                ...
                "questions": [
                  {
                    ...
                    "options": [
                      "In token 账户 (typically ATAs), not directly in the 钱包 system 账户",
                      "In the 钱包 system 账户 lamports field",
                      "Inside the 交易 signature"
                    ],
                    "answerIndex": 0,
                    "explanation": "钱包 identity 和 token balance storage are different model layers in Solana."
                  },
                  {
                    "id": "frontend-v2-l1-q2",
                    "prompt": "Why keep raw amounts as integer strings in model code?",
                    "options": [
                      "To avoid non-deterministic floating-point drift in reducers 和 tests",
                      "Because 钱包 only accept strings",
                      "Because decimals are always 9"
                    ],
                    "answerIndex": 0,
                    "explanation": "Deterministic arithmetic 和 replay debugging depend on precise integer state."
                  }
                ]
              }
            ]
            ...
            "blocks": [
              {
                ...
                "title": "Lifecycle 账户 Snapshot",
                "explorer": "AccountExplorer",
                "props": {
                  "samples": [
                    {
                      "label": "Fee Payer System 账户",
                ...
                "questions": [
                  {
                    ...
                    "prompt": "What is the safest use of optimistic UI 用于 token transfers?",
                    "options": [
                      "Show pending overlays first, mutate durable balances only after stronger confirmation",
                      "Immediately mutate all balances 和 ignore rollback",
                  ...
                  },
                  {
                    ...
                    "prompt": "Why track 交易 phases separately in telemetry?",
                    "options": [
                      "To isolate modeling failures from 钱包 和 network failures",
                      "Only to reduce logs",
                ...
                "questions": [
                  {
                    ...
                    "options": [
                      "It provides deterministic tie-breaking 用于 equal timestamps",
                      "It removes the need 用于 deduplication",
          ...
          "frontend-v2-core-reducer": {
            ...
            "hints": [
              ...
              "If event id already exists in eventsApplied, skip it 用于 idempotency.",
              "Corrections should mark replaced event ids 和 remove their effects from state transitions."
            ]
          }
        }
      },
      "frontend-v2-module-token-dashboard": {
        ...
        "lessons": {
          "frontend-v2-stream-replay-snapshots": {
            ...
            "duration": "35 min",
            "hints": [
              "Determinism starts 使用 sorting by ts then id.",
          ...
          "frontend-v2-query-layer-metrics": {
            ...
            "hints": [
              ...
              "Break sort ties by mint 用于 stable output."
            ]
          },
                ...
                "questions": [
                  {
                    ...
                    "prompt": "Why should live mode 和 replay mode share the same reducer pipeline?",
                    "options": [
                      "To keep behavior reproducible 和 avoid mode-specific correctness drift",
                      "To reduce CSS size only",
                      "Because rate limits require it"
                    ],
                    "answerIndex": 0,
                    "explanation": "Shared deterministic logic makes incident replay 和 测试 reliable."
                  },
                  {
                    ...
                    "answerIndex": 0,
                    "explanation": "Phase- 和 subsystem-specific failures require different user guidance."
                  }
                ]
              }
            ]
          ...
          "frontend-v2-dashboard-summary-checkpoint": {
            ...
            "duration": "45 min",
            "hints": [
              "Emit JSON keys in a fixed order 用于 stable snapshots.",
              "Sort top tokens deterministically 使用 tie breakers.",
              "Include modelVersion 和 fixtureHash in determinism metadata."
            ]
          }
        }
      }
            ...
            "blocks": [
              {
                ...
                "questions": [
                  ...
                  },
                  {
                    ...
                    "answerIndex": 0,
                    "explanation": "minOut is computed from quote outAmount 和 slippage bps."
                  }
                ]
              }
            ]
              ...
              },
              {
                ...
                "questions": [
                  ...
                  },
                  {
                    ...
                    "options": [
                      "用于 explainability 和 debugging route-level cost",
                      "Only 用于 CSS rendering",
            ...
            "blocks": [
              {
                ...
                "questions": [
                  {
                    "id": "defi-v2-l3-q1",
                    "prompt": "What is the primary ranking objective in this 课程 router?",
                    "options": [
                      "Maximize outAmount",
                    ...
                    "answerIndex": 0,
                    "explanation": "outAmount is primary; hops 和 route ID are tie-breakers."
                  },
                  {
                    "id": "defi-v2-l3-q2",
                    "prompt": "Why simulate virtual reserves per candidate route?",
                    "options": [
                      "To keep route quotes deterministic 和 independent",
        ...
        "lessons": {
          "defi-v2-quote-cpmm": {
            ...
            "hints": [
              ...
              "Use constant-product output formula 使用 integer floor division.",
              "Estimate impact by comparing spot price 和 effective execution price in fixed scale."
            ]
          },
          "defi-v2-router-best": {
            ...
            "duration": "35 min",
            "hints": [
              "Enumerate 1-hop direct pools first, then 2-hop through 中级 tokens.",
              "Score bestOut by output, then tie-break by hops 和 route id.",
          ...
          "defi-v2-safety-minout": {
            ...
            "hints": [
              ...
              "Compute minOut 使用 floor(out * (10000 - slippageBps) / 10000).",
                ...
                "questions": [
                  {
                    ...
                    "options": [
                      "Re-quote 和 recompute route/minOut before submit",
                      "Submit 使用 stale plan",
                  ...
                  },
                  {
                    ...
                    "options": [
                      "Deterministic planner 和 invariant failures",
                ...
                "questions": [
                  {
                    ...
                    "prompt": "Why are 账户 owner checks mandatory before deserializing state?",
                    "options": [
                      "Because callers can pass arbitrary 账户 和 forged byte layouts",
                      "Because owner checks improve rendering speed",
                      "Because owner checks replace signer checks"
                    ],
                    "answerIndex": 0,
                    "explanation": "Without owner checks, 账户 substitution allows attacker-controlled bytes to be parsed as trusted state."
                  },
                  {
                    "id": "security-v2-l1-q2",
                    "prompt": "What should be verified 用于 a privileged withdraw path?",
                    "options": [
                      "Expected authority key, signer requirement, owner check, 和 PDA derivation",
                      "Only that the vault 账户 is writable",
                      "Only that an amount field exists"
                    ],
                    "answerIndex": 0,
                    "explanation": "Privileged transitions need full identity 和 authority validation."
                  }
                ]
              }
            ]
            ...
            "blocks": [
              {
                ...
                "title": "Trace 账户 Snapshot",
                "explorer": "AccountExplorer",
                "props": {
                  "samples": [
                    {
                      "label": "Vault 账户 (vulnerable run)",
                    ...
                    {
                      "label": "Recipient 账户 (post exploit)",
                ...
                "questions": [
                  {
                    ...
                    "options": [
                      "To prove deterministic replay 和 evidence integrity",
                      "To replace structured test assertions",
                      "To randomize scenario ordering"
                    ],
                    "answerIndex": 0,
                    "explanation": "Canonical trace hashes make replay evidence comparable 和 tamper-evident."
                  },
                  {
                    ...
                    "answerIndex": 0,
                    "explanation": "This order ensures claims are demonstrated 和 patch effectiveness is validated."
                  }
                ]
              }
            ]
                ...
                "questions": [
                  {
                    ...
                    "prompt": "What is the strongest mitigation 用于 PDA spoof risks?",
                    "options": [
                      "Canonical seed schema 使用 exact re-derivation + bump verification",
                  ...
                  },
                  {
                    ...
                    "prompt": "Why are negative-path tests required 用于 audit confidence?",
                    "options": [
                      "Because most exploitable bugs only appear under malformed or adversarial input",
                      "Because happy-path tests cover all 安全 cases",
                      "Because traces are optional without them"
                    ],
                    "answerIndex": 0,
                    "explanation": "安全 failures are usually adversarial edge cases, so tests must target those edges directly."
                  }
                ]
              }
            ]
      ...
      "security-v2-vuln-lab": {
        ...
        "lessons": {
          ...
          "security-v2-exploit-pda-spoof": {
            ...
            "duration": "40 min",
            "hints": [
              "Return whether expectedPda 和 acceptedPda differ.",
              "Use strict boolean output 用于 mismatch.",
          ...
          "security-v2-patch-validate": {
            ...
            "duration": "45 min",
            "hints": [
              "All four controls must be true 用于 a complete patch.",
                ...
                "questions": [
                  {
                    ...
                    "prompt": "What is the key difference between severity 和 likelihood?",
                    "options": [
                      "Severity measures impact; likelihood measures 实战 exploitability",
                      "They are interchangeable labels",
                      "Likelihood is only 用于 low-severity bugs"
                    ],
                    "answerIndex": 0,
                  ...
                  },
                  {
                    ...
                    "options": [
                      "Require signer + owner + PDA checks 使用 explicit error codes",
                      "Improve 安全 in this function",
                      "Add more comments"
                    ],
                    "answerIndex": 0,
                    "explanation": "Actionable recommendations map directly to code changes 和 tests."
                  }
                ]
              }
            ]
          ...
          "security-v2-audit-report-checkpoint": {
            ...
            "hints": [
              ...
              "课程 must be solana-安全 和 version must be v2.",
      ...
      "token-v2-module-fundamentals": {
        ...
        "lessons": {
            ...
            "blocks": [
              {
                ...
                "questions": [
                  {
                    "id": "token-v2-l1-q1",
                    "prompt": "What is the safest default posture 用于 Token-2022 extension selection?",
                    "options": [
                      "Enable only extensions 使用 clear product 和 risk justification",
                      "Enable all extensions 用于 future flexibility",
                      "Disable authorities entirely"
                    ],
                    "answerIndex": 0,
                    "explanation": "Every extension adds 治理 和 integration complexity, so scope should stay intentional."
                  },
                  {
                    "id": "token-v2-l1-q2",
                    "prompt": "Why generate an offline deterministic launch pack before devnet/mainnet actions?",
                    "options": [
                      "To review 指令 intent 和 invariants before execution",
                      "To avoid configuring decimals",
                      "To bypass authority checks"
                    ],
                    "answerIndex": 0,
                    "explanation": "Deterministic planning provides reproducible review artifacts 和 catches config drift early."
                  }
                ]
              }
            ]
                ...
                "questions": [
                  {
                    ...
                    "options": [
                      ...
                      "Because token 账户 store floats"
                    ],
                    "answerIndex": 0,
                    "explanation": "Supply 和 distribution correctness depends on exact arithmetic over integer base units."
                  },
                  {
                    "id": "token-v2-l2-q2",
                    "prompt": "What is the primary role of freeze authority?",
                    "options": [
                      "Controlling whether specific token 账户 can transfer",
                      "Changing token symbol",
                      "Computing transfer fees"
                    ],
                    "answerIndex": 0,
                    "explanation": "Freeze authority governs transfer state at 账户 level, not branding or fee math."
                  }
                ]
              }
            ]
            ...
            "blocks": [
              {
                ...
                "questions": [
                  {
                    "id": "token-v2-l3-q1",
                    "prompt": "Why does transfer-fee max cap need scenario 测试?",
                    "options": [
                    ...
                    "answerIndex": 0,
                    "explanation": "Fee cap interacts 使用 basis points 和 can distort economic behavior if misconfigured."
                  },
                  {
                    "id": "token-v2-l3-q2",
                    "prompt": "What is a core risk of permanent delegate configuration?",
                    "options": [
                      "Privilege concentration if authority 治理 is weak",
                      "Loss of decimal precision",
                      "Automatic 钱包 incompatibility"
                    ],
                    "answerIndex": 0,
                    "explanation": "Delegate privileges must be constrained 和 governed like high-sensitivity access."
                  }
                ]
              }
            ]
          ...
          "token-v2-validate-config-derive": {
            ...
            "duration": "35 min",
            "hints": [
              "Validate decimal bounds, u64-like numeric strings, 和 recipient totals before derivation.",
              "Use one deterministic seed format 用于 mint 和 one 用于 ATA derivation.",
      ...
      "token-v2-module-launch-pack": {
        ...
        "lessons": {
          "token-v2-build-init-plan": {
            ...
            "duration": "35 min",
            "hints": [
              "Add base steps first: create mint 账户, then initialize mint 使用 decimals.",
              "Append extension steps in deterministic order so plan labels are stable.",
              "Encode each step payload 使用 version + sorted params before base64 conversion."
            ]
          },
          "token-v2-simulate-fees-supply": {
            ...
            "hints": [
              ...
              "Aggregate distributed 和 fee totals using BigInt to keep math exact.",
                ...
                "questions": [
                  {
                    ...
                    "options": [
                      "To prevent script/config drift between review 和 launch",
          ...
          "token-v2-launch-pack-checkpoint": {
            ...
            "hints": [
              ...
              "Compute recipientsTotal 和 remaining 使用 exact integer math.",
        ...
        "lessons": {
          ...
          "mobile-transaction": {
            ...
            "hints": [
              ...
              "Throw exact error message 用于 missing payer."
            ]
          }
        }
      },
        ...
        "lessons": {
          ...
          "write-bankrun-test": {
            ...
            "hints": [
              ...
              "Start reduce 使用 the initial value.",
      ...
      "indexing-v2-foundations": {
        ...
        "lessons": {
                ...
                "questions": [
                  {
                    ...
                    "options": [
                      "Program logs 和 账户 state changes",
                      "Explicit event topics like EVM",
                      "验证者 consensus messages"
                    ],
                    "answerIndex": 0,
                    "explanation": "Solana programs emit events via logs 和 state changes, not explicit event topics."
                  },
                  {
                    ...
                    "answerIndex": 0,
                    "explanation": "Idempotent ingestion ensures the same 交易 processed twice creates only one event."
                  }
                ]
              }
            ]
                ...
                "questions": [
                  {
                    ...
                    "prompt": "What is the standard size of an SPL Token 账户?",
                    "options": [
                      "165 bytes",
                      "64 bytes",
                      "256 bytes"
                    ...
                    "answerIndex": 0,
                    "explanation": "Standard SPL Token 账户 are 165 bytes, containing mint, owner, amount, 和 optional fields."
                  },
                  {
                    "id": "indexing-v2-l2-q2",
                    "prompt": "How should amount be interpreted from token 账户 data?",
                    "options": [
                    ...
                    "answerIndex": 0,
                    "explanation": "Amounts are stored as little-endian u64 和 must be converted using the mint's decimal places."
                  }
                ]
              }
            ]
          ...
          "indexing-v2-decode-token-account": {
            ...
            "duration": "45 min",
            "hints": [
              "SPL Token 账户 layout: mint (32B), owner (32B), amount (8B LE u64)",
              "Use little-endian byte order 用于 the amount field",
              "Convert bytes to base58 用于 Solana addresses"
            ]
          },
                ...
                "steps": [
                  {
                    ...
                    "output": "Program log: 指令: Transfer",
                    "note": "Top-level 指令 at depth 1"
                  },
                  {
                    "cmd": "Program 11111111111111111111111111111111 invoke [2]",
                    "output": "Program log: Create 账户",
        ...
        "lessons": {
          "indexing-v2-index-transactions": {
            ...
            "hints": [
              ...
              "Include 交易 signature 用于 traceability",
              "Sort events by index 用于 deterministic output"
            ]
          },
                ...
                "questions": [
                  {
                    ...
                    "prompt": "Why is cursor-based pagination preferred 用于 indexing?",
                    "options": [
          ...
          "indexing-v2-analytics-checkpoint": {
            ...
            "duration": "50 min",
            "hints": [
              "Aggregate events by 钱包 address",
              "Sum 交易 counts 和 volumes",
              "Sort output arrays by address 用于 determinism",
        ...
        "lessons": {
                ...
                "questions": [
                  {
                    ...
                    "options": [
                      "Attach metadata like order IDs to 交易",
                      "Encrypt payment amounts",
                      "Replace 交易 signatures"
                    ],
                    "answerIndex": 0,
                    "explanation": "SPL Memo allows attaching public metadata to 交易 用于 reference 和 tracking."
                  },
                  {
          ...
          "payments-v2-payment-intent": {
            ...
            "hints": [
              ...
              "Convert base58 to bytes 和 check the length equals 32.",
      ...
      "payments-v2-implementation": {
        ...
        "lessons": {
          "payments-v2-transfer-tx": {
            ...
            "duration": "50 min",
            "hints": [
              "SystemProgram.transfer uses 指令 index 2 使用 u64 lamports (little-endian).",
              "TokenProgram.transferChecked uses 指令 index 12 使用 u64 amount + u8 decimals.",
                ...
                "questions": [
                  {
                    ...
                    "prompt": "Why is JSON canonicalization important 用于 webhooks?",
                    "options": [
                  ...
                  },
                  {
                    ...
                    "prompt": "What algorithm is standard 用于 webhook signing?",
                    "options": [
                      "HMAC-SHA256",
                      "MD5",
                      "RSA-512"
                    ...
                    "answerIndex": 0,
                    "explanation": "HMAC-SHA256 provides strong 安全 和 is widely supported across languages."
                  }
                ]
              }
            ]
            ...
            "blocks": [
              {
                ...
                "steps": [
                  ...
                  },
                  {
                    ...
                    "note": "交易 submitted, awaiting confirmation"
                  },
                  {
                    "cmd": "State: succeeded",
        ...
        "lessons": {
                ...
                "questions": [
                  {
                    ...
                    "options": [
                      "The entire tree structure 和 all leaf data",
                      "Only the first 和 last leaf",
                      "The tree depth only"
                    ],
                    "answerIndex": 0,
                    "explanation": "The root is a cryptographic commitment to all leaves 和 their positions in the tree."
                  },
                  {
                    "id": "cnft-v2-l1-q2",
                    "prompt": "How many hash siblings are needed to prove inclusion in a tree 使用 65,536 leaves?",
                    "options": [
                      "16",
                      "256",
                      "65536"
                    ...
                    "answerIndex": 0,
                    "explanation": "Proof size is log2(65536) = 16, making verification efficient even 用于 large collections."
                  }
                ]
              }
            ]
          ...
          "cnft-v2-merkle-insert": {
            ...
            "hints": [
              ...
              "Hash the current node 使用 its sibling to get the parent hash.",
            ...
            "blocks": [
              {
                ...
                "questions": [
                  ...
                  {
                    "id": "cnft-v2-l4-q2",
                    "prompt": "How many hashes are in a proof 用于 a tree 使用 1,024 leaves?",
                    "options": [
                      "10",
                      "32",
                      "1024"
        ...
        "lessons": {
          "cnft-v2-proof-verification": {
            ...
            "hints": [
              ...
              "To verify, start 使用 the leaf hash 和 combine 使用 each proof element.",
                ...
                "steps": [
                  {
                    ...
                    "note": "Parent NFT 用于 the collection"
                  },
                  {
                    "cmd": "Merkle Tree",
                    "output": "Contains cNFT leaf hashes",
                    "note": "Scalable storage 用于 assets"
                  },
                  {
                    "cmd": "Off-chain Metadata",
                    "output": "IPFS/Arweave JSON files",
                    "note": "Full metadata 使用 hash commitment"
                  }
                ]
              }
            ]
          ...
          "cnft-v2-compression-checkpoint": {
            ...
            "hints": [
              ...
              "Create a deterministic leaf hash by combining nftId 和 owner.",
              "Insert the leaf by computing hashes up to the root, collecting sibling hashes as proof.",
              "Build an audit trace that documents the operation, inputs, 和 verification steps.",
              "Include previous 和 new root hashes in the audit 用于 transparency."
            ]
          }
        }
      }
      ...
      "governance-v2-governance": {
        ...
        "lessons": {
                ...
                "questions": [
                  {
                    ...
                    "prompt": "What is the purpose of a timelock in 治理?",
                    "options": [
                      "Allow users time to exit if they disagree 使用 outcomes",
                      "Speed up 交易 processing",
                      "Reduce gas costs"
                    ],
                    "answerIndex": 0,
                    "explanation": "Timelocks provide a safety window 用于 users to react before changes take effect."
                  },
                  {
          ...
          "governance-v2-quorum-voting": {
            ...
            "duration": "50 min",
            "hints": [
              "Sum up weights 用于 each vote choice (用于, against, abstain).",
              ...
              "Proposal passes only if quorum is met 和 support percentage >= supportThreshold."
            ]
          }
        }
      },
      "governance-v2-multisig": {
        ...
        "lessons": {
                ...
                "questions": [
                  {
                    ...
                    "options": [
                      ...
                      "2 signers total 使用 3 keys each",
                      "2 minute timeout 使用 3 retries"
                    ],
                    "answerIndex": 0,
                    "explanation": "2-of-3 means any 2 of the 3 authorized signers must approve a 交易."
                  },
                  {
                    "id": "governance-v2-l5-q2",
                    "prompt": "Why track approvals on-chain?",
                    "options": [
                      "Transparency 和 enforceability",
                      "Faster execution",
                      "Lower fees"
                    ],
                    "answerIndex": 0,
                    "explanation": "On-chain tracking provides transparency 和 ensures threshold enforcement by the protocol."
                  }
                ]
              }
            ]
          ...
          "governance-v2-multisig-builder": {
            ...
            "duration": "55 min",
            "hints": [
              "Initialize signer statuses as 'pending' 用于 all signers.",
                ...
                "questions": [
                  {
                    ...
                    "options": [
                      "Re-executing an already-executed 交易",
                      "Sending duplicate approval requests",
                      "Copying 交易 bytecode"
                    ],
                    "answerIndex": 0,
                    "explanation": "Replay attacks re-submit previously executed 交易 to drain funds."
                  },
                  {
                    "id": "governance-v2-l7-q2",
                    "prompt": "Why verify 账户 ownership?",
                    "options": [
                      "Prevent 账户 substitution attacks",
                      "Reduce 交易 size",
                      "Improve UI rendering"
                    ],
                    "answerIndex": 0,
                    "explanation": "Ownership checks ensure operations target legitimate 账户, not attacker substitutes."
                  }
                ]
              }
            ]
          ...
          "governance-v2-treasury-execution": {
            ...
            "hints": [
              ...
              "Check if currentTimestamp - approvedAt >= timelockDuration 用于 timelock validation.",
              "Sum all transfer amounts 和 compare against treasury balance.",
              "Return canExecute: false 使用 appropriate error if any validation fails.",
              "Generate state changes 和 execution trace entries 用于 each successful step."
            ]
          }
        }
      }
      ...
      "performance-v2-foundations": {
        ...
        "lessons": {
                ...
                "questions": [
                  {
                    ...
                    "prompt": "What is the default compute unit limit per 交易?",
                    "options": [
                      "200,000 CUs",
                      "1,400,000 CUs",
                      "Unlimited"
                    ...
                    "answerIndex": 0,
                    "explanation": "The default limit is 200,000 CUs, extendable to 1.4M 使用 ComputeBudgetProgram."
                  },
                  {
                    "id": "performance-v2-l1-q2",
                    "prompt": "What happens when a 交易 exceeds its compute budget?",
                    "options": [
                      "Execution halts 和 the 交易 fails",
                      "It continues 使用 reduced priority",
                      "The network automatically extends the limit"
                    ],
                    "answerIndex": 0,
                    "explanation": "Exceeding the compute budget causes immediate 交易 failure."
                  }
                ]
              }
            ]
          ...
          "performance-v2-cost-model": {
            ...
            "duration": "50 min",
            "hints": [
              "Use 5000 as the base compute unit cost per 交易.",
              "Each 账户 accessed adds 500 compute units.",
              "Each byte of data adds 10 compute units.",
              "Total = base + (账户 × 500) + (bytes × 10)."
            ]
          },
                ...
                "steps": [
                  {
                    ...
                    "output": "200 bytes, 5 账户",
                    "note": "Separate bools, duplicate 账户"
                  },
                  {
                    "cmd": "After optimization",
                    "output": "120 bytes, 3 账户",
                    "note": "Bitflags, deduplicated 账户"
                  },
                  {
                    "cmd": "Savings",
        ...
        "lessons": {
                ...
                "questions": [
                  {
                    ...
                    "options": [
                      "Set priority fee 用于 交易 inclusion",
                      "Set the maximum 交易 size",
                      "Enable additional program features"
                    ],
                    "answerIndex": 0,
                    "explanation": "Priority fees increase the likelihood of 交易 inclusion during network congestion."
                  },
                  {
                    "id": "performance-v2-l6-q2",
                    "prompt": "Why request specific compute unit limits?",
                    "options": [
                      "Pay only 用于 what you need 和 prevent waste",
                      "Increase 交易 speed",
                      "Enable more 账户 access"
                    ],
                    "answerIndex": 0,
                    "explanation": "Specific limits optimize costs - you pay 用于 the limit requested, not actual usage."
                  }
                ]
              }
            ]
                ...
                "questions": [
                  {
                    ...
                    "options": [
                      ...
                      "Optimizing before 部署",
                      "Small 性能 improvements"
                    ],
                    "answerIndex": 0,
                  ...
                  },
                  {
                    ...
                    "prompt": "What should never be sacrificed 用于 性能?",
                    "options": [
                      "安全",
                      "Code comments",
                      "Variable names"
                    ...
                    "answerIndex": 0,
                    "explanation": "安全 validations must remain regardless of 性能 optimizations."
                  }
                ]
              }
            ]
          ...
          "performance-v2-perf-checkpoint": {
            ...
            "hints": [
              ...
              "Count only optimizations where improved=true 用于 totalImprovements.",
              "Include 课程 name as 'solana-性能' 和 version as 'v2'."
            ]
          }
        }
      }
        ...
        "lessons": {
                ...
                "questions": [
                  {
                    ...
                    "options": [
                      "SPL token programs only operate on token 账户, not native SOL",
                      "Wrapping encrypts the SOL 用于 privacy",
                      "Native SOL cannot be transferred on Solana"
                    ],
                    "answerIndex": 0,
                    "explanation": "AMM programs interact 使用 SPL token 账户. Native SOL must be wrapped into the SPL token format so it can be processed by swap programs."
                  },
                  {
                    "id": "swap-v2-l1-q2",
                    "prompt": "What happens if the recipient has no ATA 用于 the output token?",
                    "options": [
                      "The swap 交易 fails unless the ATA is created in the same 交易",
                      "Solana automatically creates the ATA",
                      "The tokens are sent to the system program"
                    ],
                    "answerIndex": 0,
                    "explanation": "ATAs must be explicitly created. Including createAssociatedTokenAccountIdempotent in the 交易 handles this safely."
                  }
                ]
              }
            ]
                ...
                "questions": [
                  ...
                  },
                  {
                    ...
                    "options": [
                      ...
                      "Solana only accepts BigInt in 交易"
                    ],
                    "answerIndex": 0,
                    "explanation": "Token amounts are integers. Floating-point math can produce off-by-one errors that cause 交易 failures or incorrect minimum amounts."
                  }
                ]
              }
            ]
          ...
          "swap-v2-swap-plan": {
            ...
            "hints": [
              ...
              "Map each routePlan entry to a normalized leg 使用 index, ammLabel, mints, 和 fees.",
        ...
        "lessons": {
          "swap-v2-state-machine": {
            ...
            "hints": [
              ...
              "If an event is not valid 用于 the current state, transition to 'error' 使用 a descriptive message.",
              "Track each transition in a history array 使用 {from, event, to} objects.",
              "The 'error' state supports RESET (back to idle) 和 RETRY (back to quoting)."
            ]
          },
          "swap-v2-tx-anatomy": {
            ...
            "blocks": [
              {
                ...
                "questions": [
                  {
                    "id": "swap-v2-l6-q1",
                    "prompt": "Why are compute budget 指令 placed first in a swap 交易?",
                    "options": [
                      "The runtime reads them before executing other 指令 to set limits",
                      "They must be first 用于 signature verification",
                      "Other 指令 depend on their output"
                    ],
                    "answerIndex": 0,
                    "explanation": "Compute budget 指令 configure the 交易's CU limit 和 price before any program execution begins."
                  },
                  {
                    "id": "swap-v2-l6-q2",
                    "prompt": "What is the primary benefit of Address Lookup Tables 用于 swaps?",
                    "options": [
                      "They compress 账户 references from 32 bytes to 1 byte, fitting more 账户 in a 交易",
                      "They make 交易 faster to execute",
                      "They reduce the number of required signatures"
                    ],
                    "answerIndex": 0,
                    "explanation": "ALTs allow 交易 to reference many 账户 without exceeding the 1232-byte 交易 size limit."
                  }
                ]
              }
            ]
          ...
          "swap-v2-swap-report": {
            ...
            "hints": [
              ...
              "Collect errors from both the state machine result 和 any additional errors array.",
              "Route summary should include index, ammLabel, pct, 和 feeAmount per leg."
            ]
          }
        }
      }
                ...
                "questions": [
                  {
                    ...
                    "options": [
                      ...
                      "Lower 交易 fees 用于 traders",
                      "No need 用于 oracle price feeds"
                    ],
                    "answerIndex": 0,
                  ...
                  },
                  {
                    ...
                    "options": [
                      "To define position boundaries 和 track liquidity transitions efficiently",
                      "To make prices easier 用于 humans to read",
                      "To reduce the number of tokens in the pool"
                    ],
                    "answerIndex": 0,
                    "explanation": "Ticks provide discrete price points 用于 position boundaries, liquidity transitions, 和 efficient fee tracking at tick crossings."
                  }
                ]
              }
            ]
            ...
            "blocks": [
              {
                ...
                "questions": [
                  {
                    "id": "clmm-v2-l2-q1",
                    "prompt": "What is the sqrtPriceX64 value 用于 tick 0 (price = 1.0)?",
                    "options": [
                    ...
                    "answerIndex": 0,
                    "explanation": "At tick 0, price = 1.0, sqrt(1.0) = 1.0, 和 sqrtPriceX64 = 1.0 * 2^64 = 18446744073709551616."
                  },
                  {
                    "id": "clmm-v2-l2-q2",
                    ...
                    "options": [
                      ...
                      "It makes the price harder 用于 MEV bots to read"
                    ],
                    "answerIndex": 0,
                    "explanation": "Token amounts in a CLMM position are linear functions of sqrtPrice, making on-chain computation simpler 和 more gas-efficient."
                  }
                ]
              }
            ]
        ...
        "lessons": {
          "clmm-v2-position-fees": {
            ...
            "hints": [
              ...
              "用于 each price in the path, check if lowerPrice <= price <= upperPrice.",
                ...
                "questions": [
                  {
                    ...
                    "options": [
                      "Higher capital efficiency but more frequent out-of-range events 和 rebalancing",
                      "Lower fees but less impermanent loss",
                      "More tokens required to open the position"
                    ],
                    "answerIndex": 0,
                    "explanation": "Tight ranges concentrate capital 用于 higher efficiency 和 fee share, but the position goes out-of-range more often, requiring active management."
                  },
                  {
                    "id": "clmm-v2-l6-q2",
                    "prompt": "When should an LP consider a full-range (all ticks) position?",
                    "options": [
                      "用于 very volatile pairs where the price may swing dramatically",
                      "Only 用于 stablecoin pairs",
                      "Never — it is always suboptimal"
                    ],
                    "answerIndex": 0,
                    "explanation": "Full-range positions replicate constant product behavior 和 never go out-of-range, making them suitable 用于 highly volatile or unpredictable pairs."
                  }
                ]
              }
            ]
            ...
            "blocks": [
              {
                ...
                "questions": [
                  {
                    "id": "clmm-v2-l7-q1",
                    "prompt": "Why should you always use BigInt 用于 sqrtPriceX64 values?",
                    "options": [
                      "JavaScript Number cannot safely represent 128-bit integers",
                      "BigInt is faster than Number 用于 CLMM math",
                      "Solana requires BigInt in 交易 指令"
                    ],
                    "answerIndex": 0,
                  ...
                  {
                    "id": "clmm-v2-l7-q2",
                    "prompt": "What happens when negative ticks are aligned 使用 floor division?",
                    "options": [
                      "They round toward negative infinity — e.g., -100 使用 spacing 64 becomes -128",
                      "They round toward zero — e.g., -100 使用 spacing 64 becomes -64",
          ...
          "clmm-v2-position-report": {
            ...
            "duration": "55 min",
            "hints": [
              "Convert ticks to prices: price = 1.0001^tick. Use toFixed(6) 用于 display.",
              "Status is 'in-range' if lowerPrice <= currentPrice <= upperPrice.",
              "Sum feeHistory entries using BigInt 用于 total fees per token.",
                ...
                "questions": [
                  {
                    ...
                    "answerIndex": 0,
                    "explanation": "Above the kink, slope2 (the jump multiplier) applies, causing borrow rates to spike sharply 和 discourage further borrowing."
                  },
                  {
                    "id": "lending-v2-l2-q2",
                    "prompt": "Why is the supply rate always lower than the borrow rate?",
                    "options": [
                      "Suppliers only earn on the borrowed portion, 和 the reserve factor takes a cut",
                      "The protocol subsidizes borrowers",
                      "Supply rates are fixed by 治理"
                    ],
                    "answerIndex": 0,
                    "explanation": "Supply rate = borrowRate * utilization * (1 - reserveFactor). Since utilization < 1 和 reserveFactor > 0, the supply rate is always less than the borrow rate."
                  }
                ]
              }
            ]
                ...
                "steps": [
                  {
                    ...
                    "note": "Healthy position 使用 50% buffer before liquidation"
                  },
                  {
                    "cmd": "SOL drops to $15 ...",
                  ...
                  },
                  {
                    ...
                    "note": "Health factor below 1.0 — position is eligible 用于 liquidation"
                  }
                ]
              }
            ]
      ...
      "lending-v2-risk-management": {
        ...
        "lessons": {
          "lending-v2-health-factor": {
            ...
            "duration": "50 min",
            "hints": [
              "Collateral value = sum of (amount * priceUsd) 用于 all collateral positions.",
                ...
                "questions": [
                  {
                    ...
                    "options": [
                      ...
                      "It rewards borrowers 用于 maintaining healthy positions",
                      "It increases the interest rate 用于 all borrowers"
                    ],
                    "answerIndex": 0,
                    "explanation": "The liquidation bonus compensates liquidators 用于 gas costs 和 risk, ensuring positions are liquidated promptly to protect the protocol."
                  },
                  {
                    "id": "lending-v2-l6-q2",
                    ...
                    "answerIndex": 0,
                    "explanation": "Bad debt materializes when rapid price drops make collateral worth less than the debt, leaving the protocol 使用 unrecoverable losses."
                  }
                ]
              }
            ]
            ...
            "blocks": [
              {
                ...
                "questions": [
                  {
                    "id": "lending-v2-l7-q1",
                    "prompt": "Why should lending protocols use confidence-adjusted prices 用于 collateral?",
                    "options": [
                      ...
                      "It increases the collateral value 用于 borrowers"
                    ],
                    "answerIndex": 0,
                    "explanation": "Using price minus confidence 用于 collateral gives a conservative valuation, protecting the protocol when oracle publishers disagree or markets are volatile."
                  },
                  {
                    "id": "lending-v2-l7-q2",
                    "prompt": "What should a protocol do when all oracle feeds are stale?",
                    "options": [
                      "Pause new borrows 和 liquidations until fresh prices are available",
                      "Use the last known price regardless of age",
                      "Estimate the price from on-chain DEX data"
                    ],
                    "answerIndex": 0,
                    "explanation": "Operating on stale prices is dangerous. Pausing operations prevents incorrect liquidations 和 under-collateralized borrows during oracle outages."
                  }
                ]
              }
            ]
          ...
          "lending-v2-risk-report": {
            ...
            "duration": "55 min",
            "hints": [
              "Create a reusable evalScenario function that takes price overrides 和 computes health factor.",
              "用于 the base case, use the original position prices (empty overrides).",
              "Track the worst health factor across all scenarios.",
        ...
        "lessons": {
            ...
            "blocks": [
              {
                ...
                "questions": [
                  ...
                  {
                    "id": "perps-v2-l1-q2",
                    "prompt": "If you hold 8 SOL-PERP at $20 和 buy 2 more at $30, what is your new entry price?",
                    "options": [
                      "$22.00",
                      "$25.00",
                      "$20.00"
                ...
                "questions": [
                  {
                    ...
                    "options": [
                      ...
                      "Shorts pay longs — shorts are rewarded 用于 being correct",
                      "Both sides pay the protocol a fee"
                    ],
                    "answerIndex": 0,
                    "explanation": "A positive premium (mark > oracle) produces a positive funding rate. Longs pay shorts, which discourages excessive long demand 和 pushes the perp price back toward spot."
                  },
                  {
                    "id": "perps-v2-l2-q2",
          ...
          "perps-v2-pnl-calc": {
            ...
            "hints": [
              ...
              "Use toFixed(2) 用于 prices 和 PnL, toFixed(4) 用于 size 和 ROE."
            ]
          },
        ...
        "lessons": {
                ...
                "questions": [
                  {
                    ...
                    "options": [
                      "To ensure remaining collateral covers liquidation fees 和 slippage, preventing bad debt",
                      "To make it harder 用于 traders to open positions",
                      "To generate more revenue 用于 the protocol"
                    ],
                    "answerIndex": 0,
                    "explanation": "The maintenance buffer ensures that when a position is liquidated, there is still margin left to pay liquidation fees 和 absorb slippage during the close. Without it, positions could go underwater, creating bad debt."
                  },
                  {
                    "id": "perps-v2-l6-q2",
                ...
                "questions": [
                  {
                    ...
                    "options": [
                      "Negative size creates sign-convention bugs in notional, funding, margin, 和 liquidation calculations",
                      "Solana 账户 cannot store negative numbers",
                      "Positive numbers use less storage space"
                    ],
                    "answerIndex": 0,
                    "explanation": "When size carries the direction sign, every formula that uses size must 账户 用于 the sign — not just PnL, but also notional value, funding payments, 和 liquidation price. Keeping size positive 和 branching on a separate 'side' field is safer 和 more explicit."
                  },
                  {
                    "id": "perps-v2-l7-q2",
          ...
          "perps-v2-risk-console-report": {
            ...
            "hints": [
              ...
              "Liquidation price 用于 longs: entryPrice - (margin + funding - notional*mmRate) / size.",
      ...
      "txopt-v2-fundamentals": {
        ...
        "lessons": {
            ...
            "blocks": [
              {
                ...
                "questions": [
                  {
                    "id": "txopt-v2-l1-q1",
                    "prompt": "What is the default compute unit budget 用于 a Solana 交易?",
                    "options": [
                      "200,000 CUs",
                      "1,400,000 CUs",
                      "50,000 CUs"
                    ...
                    "answerIndex": 0,
                    "explanation": "Solana allocates 200,000 CUs by default. DeFi 交易 almost always need more, requiring an explicit SetComputeUnitLimit 指令."
                  },
                  {
                    "id": "txopt-v2-l1-q2",
                    "prompt": "What happens when a 交易's blockhash expires before it is confirmed?",
                    "options": [
                      "The 交易 is silently dropped 使用 no on-chain error",
                      "The 交易 fails 使用 a BlockhashExpired error on-chain",
                      "The 验证者 retries 使用 a fresh blockhash automatically"
                    ],
                    "answerIndex": 0,
                    "explanation": "Expired blockhash 交易 are never processed 和 produce no on-chain record. The client must detect the timeout 和 resubmit 使用 a fresh blockhash."
                  }
                ]
              }
            ]
            ...
            "blocks": [
              {
                ...
                "questions": [
                  ...
                  },
                  {
                    ...
                    "options": [
                      "CU consumption can vary slightly between simulation 和 execution due to state changes",
                      "The runtime does not accept exact values",
                      "Simulation always underreports CU usage by 50%"
                    ],
                    "answerIndex": 0,
                    "explanation": "账户 state may change between simulation 和 execution, causing minor CU variations. A 10% margin absorbs these differences."
                  }
                ]
              }
            ]
          ...
          "txopt-v2-tx-plan": {
            ...
            "duration": "50 min",
            "hints": [
              "Sum estimatedCU from all 指令, then add 10% margin: ceil(total * 1.1).",
              ...
              "Versioned tx needed when unique 账户 keys exceed 35."
            ]
          }
        }
      },
      "txopt-v2-optimization": {
        ...
        "lessons": {
          "txopt-v2-lut-planner": {
            ...
            "duration": "50 min",
            "hints": [
              "Collect all unique 账户 keys across 指令 into a set.",
              "Each key costs 32 bytes without LUT, 1 byte 使用 LUT.",
              "Base 交易 overhead is ~200 bytes. Max legacy tx size is 1232 bytes.",
            ...
            "blocks": [
              {
                ...
                "questions": [
                  {
                    "id": "txopt-v2-l6-q1",
                    "prompt": "When should you rebuild a 交易 instead of resending it?",
                    "options": [
                    ...
                    "answerIndex": 0,
                    "explanation": "Rebuilding is necessary when the 交易's blockhash is stale or when on-chain state has changed (e.g., slippage exceeded). Simple network issues only require resending the same bytes."
                  },
                  {
                    "id": "txopt-v2-l6-q2",
                    "prompt": "Why add random jitter to retry delays?",
                    "options": [
                      "To prevent many clients from retrying at the exact same moment 和 overwhelming the network",
                ...
                "steps": [
                  {
                    ...
                    "output": "Mapped: \"Price moved beyond your 0.5% tolerance. Tap Refresh 用于 updated quote.\"",
                    "note": "Slippage exceeded -> actionable message"
                  },
                  {
                    "cmd": "Raw: Attempt to debit an account but found no record of a prior credit",
                    "output": "Mapped: \"Insufficient SOL balance. Need 0.05 SOL, have 0.01 SOL. Fund 钱包 to continue.\"",
                    "note": "Balance error -> show exact shortfall"
                  },
                  {
                    "cmd": "Raw: Transaction was not confirmed in 30.00 seconds",
                    "output": "Mapped: \"交易 pending. Check status or retry 使用 higher priority fee.\" [Check Status] [Retry]",
                    "note": "Timeout -> offer both check 和 retry options"
                  }
                ]
              }
            ]
          ...
          "txopt-v2-send-strategy": {
            ...
            "duration": "55 min",
            "hints": [
              "Combine tx plan building 和 LUT planning into one comprehensive report.",
      ...
      "mobilesign-v2-fundamentals": {
        ...
        "lessons": {
                ...
                "questions": [
                  {
                    ...
                    "prompt": "What enables persistent dApp-to-钱包 communication on Android?",
                    "options": [
                    ...
                    "answerIndex": 0,
                    "explanation": "Android MWA uses foreground services to maintain a persistent communication channel between the dApp 和 钱包, enabling multi-request sessions without app switching."
                  },
                  {
                    "id": "mobilesign-v2-l1-q2",
                    "prompt": "Why can't iOS maintain persistent 钱包 sessions like Android?",
                    "options": [
                      "iOS suspends app execution on background transitions, preventing persistent channels",
                      "iOS 钱包 do not support Solana",
                ...
                "questions": [
                  {
                    ...
                    "prompt": "What should you do before showing any 钱包 connection UI?",
                    "options": [
                      "Detect available connection methods (MWA, deep links, QR)",
                      "Immediately open the default 钱包",
                      "Display a loading spinner 用于 3 seconds"
                    ],
                    "answerIndex": 0,
                  ...
                  },
                  {
                    ...
                    "prompt": "How should a dApp handle a network mismatch between itself 和 the 钱包?",
                    "options": [
                      "Display a clear message asking the user to switch their 钱包's network",
                      "Silently retry the 交易 on a different cluster",
                      "Ignore the mismatch 和 hope it resolves"
                    ],
                    "answerIndex": 0,
                    "explanation": "Network mismatches should be communicated clearly to the user 使用 指令 on how to resolve them, avoiding confusing silent failures."
                  }
                ]
              }
            ]
                ...
                "steps": [
                  {
                    ...
                    "output": "Fetch blockhash, construct 指令, serialize to base64",
                    "note": "交易 construction phase"
                  },
                  {
                    "cmd": "T+0.5s  dApp -> wallet: sign_transactions request",
                    "output": "{\"type\":\"交易\",\"payload\":\"AQAAA...\",\"requestId\":\"req_001\"}",
                  ...
                  },
                  {
                    ...
                    "note": "钱包 simulates 和 extracts display info"
                  },
                  {
          ...
          "mobilesign-v2-sign-request": {
            ...
            "duration": "50 min",
            "hints": [
              "Validate type is either '交易' or 'message' before checking payload format.",
              "交易 payloads must be valid base64 (A-Z, a-z, 0-9, +, /, optional = padding, length divisible by 4).",
              "App identity requires at least name 和 URI. Icon is optional but should default to empty string.",
        ...
        "lessons": {
          "mobilesign-v2-session-persist": {
            ...
            "hints": [
              ...
              "Save sets walletAddress, lastRequestId, sessionActive=true, 和 expiresAt = timestamp + TTL.",
              "Restore succeeds only if session is active 和 current time < expiresAt.",
                ...
                "questions": [
                  {
                    ...
                    "prompt": "How should token amounts be displayed on a mobile 交易 review screen?",
                    "options": [
                      "使用 correct decimal places 和 token symbol (e.g., 1.50 USDC)",
                      "As raw lamports or smallest unit values",
                      "In scientific notation 用于 precision"
                    ],
                    "answerIndex": 0,
                    "explanation": "Token amounts must be converted to human-readable format using the token's decimal configuration 和 include the symbol 用于 clarity."
                  },
                  {
                    "id": "mobilesign-v2-l6-q2",
                    "prompt": "What is the most intuitive way to present 交易 simulation results?",
                    "options": [
                      "Balance change summaries 使用 color-coded increases 和 decreases",
                      "Raw simulation logs from the RPC response",
                      "A list of all 账户 the 交易 touches"
                    ],
                    "answerIndex": 0,
                    "explanation": "Balance change summaries (e.g., -1.5 SOL, +150 USDC) are the most user-friendly way to communicate what a 交易 will do."
                  }
                ]
              }
            ]
            ...
            "blocks": [
              {
                ...
                "steps": [
                  ...
                  },
                  {
                    ...
                    "output": "Opening 钱包 用于 approval... requestId=req_001",
                    "note": "Request sent to 钱包 via MWA or deep link"
                  },
                  {
                    "cmd": "State: signing -> failed (timeout after 30s)",
                    "output": "钱包 did not respond. Failure: SIGNING_TIMEOUT",
                    "note": "钱包 app may have been closed or crashed"
                  },
                  {
                    "cmd": "State: failed -> retrying (attempt 1/3, delay 1s)",
                    "output": "Refreshing blockhash... Retrying in 1s...",
                    "note": "Automatic retry 使用 fresh blockhash"
                  },
                  {
                    "cmd": "State: retrying -> signing",
                    "output": "Re-opening 钱包 用于 approval... requestId=req_001_r1",
                    "note": "New request sent 使用 updated blockhash"
                  },
                  {
                    "cmd": "State: signing -> submitted",
                    "output": "钱包 approved. Submitting tx: 5UzM...",
                    "note": "Signed 交易 submitted to network"
                  },
                  {
                    "cmd": "State: submitted -> confirmed",
                    "output": "交易 confirmed in slot 234567890. Success!",
          ...
          "mobilesign-v2-session-report": {
            ...
            "hints": [
              ...
              "Sum retries across all requests 用于 total retry attempts.",
              "Session duration = sessionEnd - sessionStart in seconds.",
              "Request breakdown counts how many were '交易' vs 'message' type."
            ]
          }
        }
      }
        ...
        "lessons": {
                ...
                "questions": [
                  {
                    ...
                    "prompt": "What is the correct URL scheme 用于 Solana Pay transfer requests?",
                    "options": [
                    ...
                    "answerIndex": 0,
                    "explanation": "The Solana Pay specification uses the 'solana:' scheme followed immediately by the recipient address 使用 no slashes."
                  },
                  {
                    "id": "solanapay-v2-l1-q2",
                    "prompt": "When should you use a 交易 request instead of a transfer request?",
                    "options": [
                      "When the payment requires multiple 指令 or program interactions beyond a simple transfer",
                      "When the amount exceeds 100 SOL",
                      "When paying 使用 native SOL instead of SPL tokens"
                    ],
                    "answerIndex": 0,
                    "explanation": "交易 requests allow the server to build arbitrarily complex 交易. Transfer requests only support simple single-token transfers."
                  }
                ]
              }
            ]
                ...
                "questions": [
                  {
                    ...
                    "options": [
                      "It is added as a non-signer 账户, allowing getSignaturesForAddress to find the 交易",
                      "It creates a webhook that notifies the merchant",
                      "It stores the payment ID in the 交易 memo"
                    ],
                    "answerIndex": 0,
                    "explanation": "The reference public key is included as a non-signer 账户 in the transfer 指令. The merchant polls getSignaturesForAddress(reference) to detect when the payment 交易 confirms."
                  },
                  {
                    ...
                    "options": [
                      ...
                      "amount=2500000 (raw units 使用 6 decimals)",
                      "amount=2500000000 (raw units 使用 9 decimals)"
                    ],
                    "answerIndex": 0,
                    "explanation": "Solana Pay URLs use human-readable decimal amounts. The 钱包 handles the conversion to raw units based on the token's decimal configuration."
                  }
                ]
              }
            ]
            ...
            "blocks": [
              {
                ...
                "steps": [
                  ...
                  },
                  {
                    ...
                    "note": "SPL token transfer 使用 tracking reference"
                  },
                  {
                    ...
                    "note": "Complete POS payment request 使用 all fields"
                  }
                ]
              }
            ]
          ...
          "solanapay-v2-encode-transfer": {
            ...
            "hints": [
              ...
              "Use encodeURIComponent 用于 label 和 message to handle special characters."
            ]
          }
        }
      },
                ...
                "questions": [
                  {
                    ...
                    "prompt": "When is 'confirmed' commitment sufficient versus waiting 用于 'finalized'?",
                    "options": [
                      "Confirmed is sufficient 用于 low-value POS 交易; finalized is needed 用于 irreversible digital fulfillment",
                      "Always wait 用于 finalized regardless of 交易 value",
                      "Confirmed is never sufficient — always use finalized"
                    ],
                    "answerIndex": 0,
                    "explanation": "用于 coffee-shop-scale payments, confirmed commitment provides a strong enough guarantee. Finalized adds 6-12 seconds of latency 和 is only necessary when fulfillment is irreversible."
                  },
                  {
                    "id": "solanapay-v2-l6-q2",
                    "prompt": "What should happen when the payment request expires?",
                    "options": [
                      "Display a clear expiry message 使用 an option to generate a new QR code",
                      "Silently restart the polling loop",
                      "Redirect the customer to a different payment method"
                    ],
                    "answerIndex": 0,
                    "explanation": "Expired requests should be clearly communicated. The customer may have been in the middle of approving — they need to know the request expired 和 can try again."
                  }
                ]
              }
            ]
        ...
        "lessons": {
                ...
                "questions": [
                  {
                    ...
                    "options": [
                      ...
                      "Redirect the user to a 钱包 installation page"
                    ],
                    "answerIndex": 0,
                  ...
                  },
                  {
                    ...
                    "options": [
                      "It prevents layout shift 和 sets expectations 用于 where content will appear",
                      "It makes the page load faster",
                      "It is required by the Solana 钱包 adapter standard"
                    ],
                    "answerIndex": 0,
                    "explanation": "Skeleton UI reserves the layout space 用于 钱包-dependent content, preventing jarring shifts when the connection resolves 和 data loads."
                  }
                ]
              }
            ]
                ...
                "questions": [
                  {
                    ...
                    "options": [
                      "Call getGenesisHash() 和 compare against known cluster genesis hashes",
                      "Check the URL string 用于 'mainnet' or 'devnet'",
                      "Ask the 钱包 adapter which network it is using"
                    ],
                    "answerIndex": 0,
                    "explanation": "Each Solana cluster has a unique genesis hash. Comparing the RPC's genesis hash against known values is the only reliable detection method, since URL strings can be misleading 和 钱包 don't always expose network info."
                  },
                  {
                    "id": "walletux-v2-l2-q2",
                    "prompt": "What must happen to cached data when the network changes?",
                    "options": [
                      "All cached data must be invalidated because 账户 states differ across clusters",
                      "Only token balances need to be refreshed",
                      "Cached data can be retained since addresses are the same across clusters"
                    ],
                    "answerIndex": 0,
                    "explanation": "While 账户 addresses are identical across clusters, the 账户 states (balances, data, existence) are completely different. All cached RPC data must be cleared on network switch."
                  }
                ]
              }
            ]
          ...
          "walletux-v2-connection-state": {
            ...
            "hints": [
              ...
              "CONNECTED 和 ACCOUNT_CHANGE events carry walletAddress. CONNECTED 和 NETWORK_CHANGE carry network.",
              "Error state stores the error message. Disconnected clears all session data.",
              "Invalid events force transition to error state 使用 descriptive message."
            ]
          }
        }
      },
      "walletux-v2-production": {
        ...
        "lessons": {
          "walletux-v2-cache-invalidation": {
            ...
            "duration": "50 min",
            "hints": [
              "ACCOUNT_CHANGE invalidates entries tagged '账户'.",
              "NETWORK_CHANGE invalidates both 'network' 和 '账户' tagged entries.",
              "DISCONNECT invalidates all non-'global' entries.",
                ...
                "questions": [
                  {
                    ...
                    "options": [
                      "账户 states differ across clusters, so cached devnet data would be wrong 用于 mainnet",
                      "Cache keys must be globally unique 用于 性能",
                      "The Solana RPC protocol requires cluster identification"
                    ],
                    "answerIndex": 0,
                    "explanation": "The same 账户 address can have completely different state on mainnet vs devnet. Without the network in the key, switching clusters would return stale data from the previous cluster."
                  },
                  {
                    "id": "walletux-v2-l6-q2",
                    "prompt": "What does the stale-while-revalidate pattern do when a cache entry is past its TTL?",
                    "options": [
                      "Returns the stale value immediately 和 triggers a background re-fetch",
                      "Blocks until fresh data is fetched from the RPC",
                      "Deletes the stale entry 和 returns null"
                    ],
                    "answerIndex": 0,
                    "explanation": "SWR prioritizes responsiveness by serving stale data instantly while refreshing in the background. This eliminates loading states 用于 data that has only slightly exceeded its TTL."
                  }
                ]
              }
            ]
          ...
          "walletux-v2-ux-report": {
            ...
            "duration": "55 min",
            "hints": [
              "Count CONNECT events 用于 attempts, CONNECTED 用于 successes.",
        ...
        "lessons": {
            ...
            "blocks": [
              {
                ...
                "questions": [
                  {
                    "id": "siws-v2-l1-q1",
                    "prompt": "What is the primary 安全 problem 使用 using raw signMessage 用于 authentication?",
                    "options": [
                      "钱包 cannot distinguish sign-in requests from malicious payloads",
                      "signMessage is too slow 用于 production use",
                      "signMessage does not produce valid Ed25519 signatures"
                    ],
                    "answerIndex": 0,
                    "explanation": "Without structured format, 钱包 treat signMessage payloads as opaque bytes 和 cannot validate or warn about the content, making it easy 用于 malicious dApps to disguise harmful payloads as sign-in requests."
                  },
                  {
                    "id": "siws-v2-l1-q2",
                    ...
                    "options": [
                      ...
                      "By encrypting the signed message 使用 AES-256",
                      "By requiring the user to sign twice 使用 different keys"
                    ],
                    "answerIndex": 0,
                    "explanation": "The server generates a unique nonce 用于 each sign-in attempt. After successful verification, the nonce is marked as consumed. Any reuse of the same nonce is rejected as a replay attack."
                  }
                ]
              }
            ]
                ...
                "questions": [
                  {
                    ...
                    "options": [
                      ...
                      "钱包 cannot sign messages containing client-generated nonces"
                    ],
                    "answerIndex": 0,
                    "explanation": "If the client generates nonces, an attacker can replay a previously captured nonce-signature pair. Server-generated nonces ensure each authentication attempt is unique 和 controlled by the server."
                  },
                  {
                    "id": "siws-v2-l2-q2",
                    ...
                    "options": [
                      ...
                      "Full URL 使用 protocol (e.g., https://example.com)",
                      "IP address 使用 port number"
                    ],
                    "answerIndex": 0,
                    "explanation": "The domain field must be a plain domain name. Protocol prefixes, paths, ports, 和 query strings must be rejected to ensure consistent domain matching."
                  }
                ]
              }
            ]
          ...
          "siws-v2-sign-in-input": {
            ...
            "hints": [
              ...
              "Nonce must be >= 8 characters 和 alphanumeric only (/^[a-zA-Z0-9]+$/).",
      ...
      "siws-v2-verification": {
        ...
        "lessons": {
          "siws-v2-verify-sign-in": {
            ...
            "duration": "50 min",
            "hints": [
              "Compare domain, nonce, 和 address between signInOutput 和 expected values.",
              "issuedAt must be <= currentTime (not in the future).",
              "expirationTime (if present) must be > currentTime.",
              "All five checks must pass 用于 verified = true."
            ]
          },
          "siws-v2-sessions": {
            ...
            "blocks": [
              {
                ...
                "questions": [
                  {
                    "id": "siws-v2-l6-q1",
                    "prompt": "Why should session IDs be random tokens rather than 钱包 addresses?",
                    "options": [
                      "钱包 addresses are public, so anyone could forge requests using a known address",
                      "Random tokens are shorter 和 save bandwidth",
                      "钱包 addresses change frequently 和 break sessions"
                    ],
                    "answerIndex": 0,
                    "explanation": "钱包 addresses are publicly known. Using them as session IDs would allow anyone who knows a user's address to impersonate their session. Random tokens ensure only the authenticated client can present a valid session."
                  },
                  {
                    "id": "siws-v2-l6-q2",
                    "prompt": "What should happen when a user disconnects their 钱包 from a dApp?",
                    "options": [
                      "The dApp should invalidate the server-side session (treat it as logout)",
                      "Nothing — the session should persist 用于 convenience",
                      "The dApp should reconnect the 钱包 automatically"
                    ],
                    "answerIndex": 0,
                    "explanation": "钱包 disconnection signals the user's intent to end the interaction. The dApp should respect this by invalidating the session, preventing confusion about authentication state."
                  }
                ]
              }
            ]
                ...
                "steps": [
                  {
                    ...
                    "note": "Cryptographically random, stored in Redis 使用 10-min TTL"
                  },
                  {
                    "cmd": "Server: issue SIWS input to client",
                    "output": "{\"domain\":\"example.com\",\"nonce\":\"k9Xm2pQr7vNw4cBh\",\"issuedAt\":\"...\"}",
                    "note": "Nonce travels: server -> client -> 钱包 -> signed output"
                  },
                  {
          ...
          "siws-v2-auth-report": {
            ...
            "hints": [
              ...
              "Count successful (verified + new nonce), failed (not verified), 和 replay-blocked separately.",
              "Use an address set to count unique addresses.",
              "Build nonce registry 使用 status: 'consumed', 'rejected', or 'replay-blocked'."
            ]
          }
        }
      }
            ...
            "blocks": [
              {
                ...
                "questions": [
                  {
                    "id": "pfcb-v2-l1-q1",
                    "prompt": "Why should compute unit limit 和 price be planned together?",
                    "options": [
                      "Because inclusion depends on both requested resources 和 bid intensity",
                      "Because compute unit limit is ignored by 验证者",
                      "Because priority fee is fixed per 交易"
                    ],
                    "answerIndex": 0,
                    "explanation": "A large CU request 使用 weak price can lose inclusion, while aggressive price on oversized CU can overpay."
                  },
                  {
                    "id": "pfcb-v2-l1-q2",
                    ...
                    "options": [
                      ...
                      "A bug in 交易 serialization",
                      "Guaranteed finalized confirmation"
                    ],
                    "answerIndex": 0,
                    "explanation": "Spread growth signals unstable contention 和 lower reliability 用于 naive median pricing."
                  }
                ]
              }
            ]
      ...
      "pfcb-v2-project-journey": {
        ...
        "lessons": {
          "pfcb-v2-plan-compute-budget": {
            ...
            "duration": "40 min",
            "hints": [
              "Compute units should be ceil(total CU * 1.1) 使用 a floor of 80k 和 max of 1.4M.",
              "Enable heapBytes 用于 very large tx payloads or high CU totals.",
              "Return a deterministic reason string 用于 test stability."
            ]
          },
          "pfcb-v2-estimate-priority-fee": {
            ...
            "hints": [
              ...
              "Clamp output between min 和 max micro-lamports."
            ]
          },
          "pfcb-v2-confirmation-ux-policy": {
            ...
            "hints": [
              ...
              "Keep output deterministic 和 string-stable."
            ]
          },
          "pfcb-v2-fee-plan-summary-markdown": {
            ...
            "duration": "35 min",
            "hints": [
              "Markdown output should be deterministic 和 human-readable.",
          ...
          "pfcb-v2-fee-optimizer-checkpoint": {
            ...
            "duration": "45 min",
            "hints": [
              "Return stable JSON 使用 sorted warning strings.",
                ...
                "questions": [
                  {
                    ...
                    "options": [
                      "Because intent-level 思维模型s are all-or-nothing",
                      "Because protocols always guarantee it",
                      "Because 钱包 adapters hide all failures"
                    ],
                    "answerIndex": 0,
                    "explanation": "Users think in outcomes, not internal 交易 decomposition."
                  }
                ]
              }
            ]
            ...
            "blocks": [
              {
                ...
                "props": {
                  "samples": [
                    ...
                    {
                      "label": "Safe flow 使用 compensation",
      ...
      "bundles-v2-project-journey": {
        ...
        "lessons": {
          "bundles-v2-build-atomic-flow": {
            ...
            "duration": "40 min",
            "hints": [
              "Normalize order by step ID 和 dependency ID 用于 deterministic flow graphs.",
          ...
          "bundles-v2-validate-atomicity": {
            ...
            "duration": "40 min",
            "hints": [
              "Detect missing refund branch 用于 swap flows.",
          ...
          "bundles-v2-failure-handling-patterns": {
            ...
            "hints": [
              ...
              "Always emit explicit refund-path state 用于 observability."
            ]
          },
          "bundles-v2-bundle-composer": {
            ...
            "hints": [
              ...
              "One step per 交易 keeps test assertions simple 和 stable."
            ]
          },
                ...
                "questions": [
                  {
                    ...
                    "prompt": "What is the primary difference between slippage 和 价格影响?",
                    "options": [
                      "Slippage is user tolerance; impact is market footprint",
                      "They are identical metrics",
                      "价格影响 only applies on CEXs"
                    ],
                    "answerIndex": 0,
      ...
      "mempoolux-v2-project-journey": {
        ...
        "lessons": {
          "mempoolux-v2-evaluate-swap-risk": {
            ...
            "duration": "40 min",
            "hints": [
              "Use additive policy scoring from quote freshness, slippage, impact, route, 和 liquidity.",
              "Return both risk grade 和 concrete reasons 用于 UX copy generation."
            ]
          },
          "mempoolux-v2-slippage-guard": {
            ...
            "hints": [
              ...
              "Stale quotes should lower tolerance 和 may block if very stale."
            ]
          },
          "mempoolux-v2-impact-vs-slippage": {
            ...
            "hints": [
              ...
              "Return both ratio 和 interpretation 用于 UI hints."
            ]
          },
          "mempoolux-v2-swap-safety-banner": {
            ...
            "hints": [
              ...
              "Avoid exploit framing; keep copy defensive 和 user-focused."
            ]
          },
          "mempoolux-v2-protection-config-export": {
            ...
            "duration": "45 min",
            "hints": [
              "Checkpoint output should be deterministic JSON 用于 copy/export behavior.",
                ...
                "questions": [
                  {
                    ...
                    "prompt": "Why is 指令 index important in event keys?",
                    "options": [
                      "It helps prevent collisions when one 交易 emits similar events",
                      "It reduces RPC cost directly",
                      "It replaces confirmation checks"
                    ],
                    "answerIndex": 0,
                    "explanation": "指令 index distinguishes same-signature events that would otherwise collide in dedupe."
                  }
                ]
              }
            ]
            ...
            "blocks": [
              {
                ...
                "steps": [
                  ...
                  },
                  {
                    ...
                    "note": "Candidate 用于 provisional state."
                  }
                ]
              }
            ]
      ...
      "indexpipe-v2-project-journey": {
        ...
        "lessons": {
          "indexpipe-v2-dedupe-events": {
            ...
            "duration": "40 min",
            "hints": [
              "Build stable composite keys 用于 dedupe.",
          ...
          "indexpipe-v2-apply-confirmations": {
            ...
            "hints": [
              ...
              "Track pending 和 finalized sets separately 用于 reorg safety."
            ]
          },
          "indexpipe-v2-backfill-idempotency": {
            ...
            "duration": "35 min",
            "hints": [
              "Backfills should be resumable 和 idempotent.",
              "Emit a deterministic key 用于 replay-safe job scheduling."
            ]
          },
          ...
          "indexpipe-v2-pipeline-report-checkpoint": {
            ...
            "duration": "45 min",
            "hints": [
              "Checkpoint output should be markdown 和 deterministic.",
              "Include applied/pending/finalized counts 和 integrity result."
            ]
          }
        }
      }
                ...
                "questions": [
                  {
                    ...
                    "options": [
                      ...
                      "Slot lag only affects 验证者 rewards",
            ...
            "blocks": [
              {
                ...
                "steps": [
                  ...
                  },
                  {
                    ...
                    "output": "score lower due to throttling 和 lag",
      ...
      "rpc-v2-project-journey": {
        ...
        "lessons": {
          ...
          "rpc-v2-select-endpoint": {
            ...
            "duration": "40 min",
            "hints": [
              "Blend success rate, latency, 429 pressure, 和 slot lag into one score.",
          ...
          "rpc-v2-cache-invalidation-policy": {
            ...
            "duration": "35 min",
            "hints": [
              "Invalidate 账户-keyed cache entries deterministically.",
          ...
          "rpc-v2-metrics-reducer": {
            ...
            "duration": "35 min",
            "hints": [
              "Reduce RPC telemetry into histogram buckets 和 quantiles.",
              "Keep bucket boundaries explicit 用于 deterministic snapshots."
            ]
          },
          "rpc-v2-health-report-checkpoint": {
            ...
            "duration": "45 min",
            "hints": [
              "Checkpoint should export both JSON 和 markdown.",
            ...
            "blocks": [
              {
                ...
                "questions": [
                  {
                    "id": "rdb-v2-l1-q1",
                    "prompt": "Why does a u8 before u64 often increase 账户 size?",
                    "options": [
      ...
      "rdb-v2-project-journey": {
        ...
        "lessons": {
          "rdb-v2-compute-layout": {
            ...
            "duration": "40 min",
            "hints": [
              "Use alignment-aware offsets 和 include padding fields in the result.",
          ...
          "rdb-v2-borsh-encode-decode": {
            ...
            "hints": [
              ...
              "Keep encode/decode symmetric 用于 deterministic tests."
            ]
          },
          ...
          "rdb-v2-safe-parse-account-data": {
            ...
            "hints": [
              ...
              "Return structured errors 用于 invalid booleans 和 unsupported field types."
            ]
          },
          "rdb-v2-layout-report-checkpoint": {
            ...
            "hints": [
              ...
              "Avoid random IDs 和 timestamps in output."
            ]
          }
        }
      }
                ...
                "questions": [
                  {
                    ...
                    "options": [
                      ...
                      "They remove need 用于 logs",
                      "They reduce compile time"
                    ],
                    "answerIndex": 0,
                    "explanation": "Typed codes make handling 和 monitoring deterministic."
                  }
                ]
              }
            ]
        ...
        "lessons": {
          "rei-v2-invariant-error-helpers": {
            ...
            "hints": [
              ...
              "Keep ensure() deterministic 和 side-effect free."
            ]
          },
          "rei-v2-evidence-chain-builder": {
            ...
            "duration": "40 min",
            "hints": [
              "Inject/mock timestamps 用于 deterministic evidence chains.",
              "Step ordering must remain stable 用于 snapshot tests."
            ]
          },
          "rei-v2-property-ish-invariant-tests": {
            ...
            "hints": [
              ...
              "Return explicit failed IDs 用于 debugability."
            ]
          },
          "rei-v2-format-report": {
            ...
            "duration": "35 min",
            "hints": [
              "Markdown report should preserve stable step order 和 deterministic formatting.",
              "Include aggregate status 和 per-step evidence lines."
            ]
          },
                ...
                "steps": [
                  {
                    ...
                    "note": "Good 用于 sequential work"
                  },
                  {
                    "cmd": "HashMap lookups",
                    "output": "fast random access, hash overhead",
                    "note": "Good 用于 key-based fetch"
                  }
                ]
              }
            ]
      ...
      "rpot-v2-project-journey": {
        ...
        "lessons": {
          "rpot-v2-cost-model-estimate": {
            ...
            "duration": "40 min",
            "hints": [
              "Use deterministic arithmetic weights 用于 each operation category.",
              "Return component breakdown plus total 用于 easier optimization diffs."
            ]
          },
          ...
          "rpot-v2-perf-report-checkpoint": {
            ...
            "duration": "45 min",
            "hints": [
              "Checkpoint must include stable JSON 和 markdown outputs.",
            ...
            "blocks": [
              {
                ...
                "questions": [
                  {
                    "id": "raip-v2-l1-q1",
                    "prompt": "Why prefer bounded concurrency 用于 indexer tasks?",
                    "options": [
                      "It prevents runaway memory 和 queue growth",
                      "It guarantees zero failures",
                      "It eliminates retries"
                    ],
                    "answerIndex": 0,
                    "explanation": "Bounded concurrency keeps load behavior controlled 和 observable."
                  }
                ]
              }
            ]
      ...
      "raip-v2-project-journey": {
        ...
        "lessons": {
          "raip-v2-pipeline-run": {
            ...
            "duration": "40 min",
            "hints": [
              "Model bounded concurrency 使用 a deterministic queue 和 tick loop.",
          ...
          "raip-v2-retry-policy": {
            ...
            "duration": "40 min",
            "hints": [
              "Retry schedule should be deterministic 和 bounded.",
              "Support linear 和 exponential backoff modes."
            ]
          },
          "raip-v2-idempotency-dedupe": {
            ...
            "hints": [
              ...
              "Return stable sorted keys 用于 deterministic snapshots."
            ]
          },
          "raip-v2-snapshot-reducer": {
            ...
            "duration": "35 min",
            "hints": [
              "Reducer should be deterministic 和 idempotent-friendly.",
              "Sort output keys 用于 stable report generation."
            ]
          },
          "raip-v2-pipeline-report-checkpoint": {
            ...
            "hints": [
              ...
              "Include both machine 和 human-readable export fields."
            ]
          }
        }
      }
            ...
            "blocks": [
              {
                ...
                "questions": [
                  {
                    "id": "rpmcs-v2-l1-q1",
                    "prompt": "Why is generated code review important 用于 safety?",
                    "options": [
                      "It verifies expansion matches policy intent",
                      "It increases compile speed",
                      "It removes need 用于 tests"
                    ],
                    "answerIndex": 0,
                    "explanation": "Generated checks must remain inspectable 和 auditable."
                  }
                ]
              }
            ]
        ...
        "lessons": {
          "rpmcs-v2-parse-attributes": {
            ...
            "hints": [
              ...
              "Support signer, mut, owner, 和 has_one forms."
            ]
          },
          ...
          "rpmcs-v2-run-generated-checks": {
            ...
            "duration": "35 min",
            "hints": [
              "Evaluate generated constraints against sample 账户 state.",
          ...
          "rpmcs-v2-generated-safety-report": {
            ...
            "hints": [
              ...
              "Include status 和 explicit failure details."
            ]
          }
        }
      }
      ...
      "aum-v2-module-1": {
        ...
        "lessons": {
            ...
            "blocks": [
              {
                ...
                "questions": [
                  {
                    "id": "aum-v2-l1-q1",
                    "prompt": "What is the most defensible release gate before 部署?",
                    "options": [
                      "Compare approved build hash to expected programdata hash policy input",
                      "Ship quickly 和 validate hash later",
                      "Rely on signer memory without written report"
                    ],
                    "answerIndex": 0,
                    "explanation": "Hash matching is a deterministic control that prevents artifact drift during 部署."
                  },
                  {
                    "id": "aum-v2-l1-q2",
                    "prompt": "Why is release communication part of upgrade safety?",
                    "options": [
                      "Integrators need exact migration impact 和 timing to avoid operational errors",
                      "Because Anchor automatically writes support tickets",
                      "Because all upgrades are backward compatible"
                    ],
                    "answerIndex": 0,
                    "explanation": "Unclear upgrade messaging causes integration mistakes 和 user-facing incidents."
                  }
                ]
              }
            ]
                ...
                "steps": [
                  {
                    ...
                    "note": "Freeze writes before touching 账户 schema."
                  },
                  {
                    "cmd": "migrate --batch=3 --range=2000-2999 --target=v3",
                    "output": "status=ok migrated=1000 failed=0",
                    "note": "Batch IDs are deterministic 和 replayable."
                  }
                ]
              }
            ]
          ...
          "aum-v2-plan-migration-steps": {
            ...
            "duration": "40 min",
            "hints": [
              "Use Math.ceil(accountCount / batchSize) 用于 deterministic batch count.",
              "requiresMigration should be true only when toVersion > fromVersion.",
              "Return only stable scalar fields 用于 exact JSON comparisons."
            ]
          }
        }
      },
      "aum-v2-module-2": {
        ...
        "lessons": {
          "aum-v2-validate-upgrade-safety": {
            ...
            "duration": "40 min",
            "hints": [
              "Treat missing authority, hash mismatch, 和 failed dry run as blocking issues.",
                ...
                "questions": [
                  {
                    ...
                    "options": [
                      "Enter defined response mode: pause risky actions 和 publish status",
                  ...
                  },
                  {
                    ...
                    "answerIndex": 0,
                    "explanation": "Incident fixtures turn 课时 into enforceable regression tests."
                  }
                ]
              }
            ]
          ...
          "aum-v2-upgrade-report-markdown": {
            ...
            "duration": "35 min",
            "hints": [
              "Keep line ordering 和 punctuation stable.",
              "Use bullet list fields 用于 releaseTag, totalBatches, 和 issueCount.",
        ...
        "lessons": {
          ...
          "lesson-10-1-2": {
            ...
            "hints": [
              ...
              "用于 exponential backoff, use 2_u64.pow(attempt) to calculate the multiplier",
          ...
          "lesson-10-1-3": {
            ...
            "hints": [
              ...
              "用于 time_remaining, subtract current_time from deadline timestamp if not expired",
              "用于 extend_deadline, calculate the new timestamp 和 check against max allowed"
            ]
          },
          "lesson-10-1-4": {
            ...
            "duration": "45 min",
            "hints": [
              "Call the primary function first 和 check if it returns Some",
              "Only call fallback if primary returns None",
              "用于 retry, loop max_retries times trying primary before falling back"
            ]
          }
        }
      },
      "mod-10-2": {
        ...
        "lessons": {
          ...
          "lesson-10-2-2": {
            ...
            "duration": "45 min",
            "hints": [
              "In can_execute, check if recovery timeout has passed 用于 Open state",
              "record_success should reset everything to Closed state",
              "record_failure increments count 和 opens circuit when threshold is reached"
            ]
          },
          "lesson-10-2-3": {
            ...
            "hints": [
              ...
              "Calculate elapsed time 和 multiply by refill rate to get tokens to add",
          ...
          "lesson-10-2-4": {
            ...
            "duration": "45 min",
            "hints": [
              "Use match 使用 range patterns (1000..=1999) to classify",
      ...
      "mod-11-1": {
        ...
        "lessons": {
          ...
          "lesson-11-1-2": {
            ...
            "duration": "45 min",
            "hints": [
              "Compare actual vs expected values 和 return appropriate Result",
              "Use format! to create descriptive error messages",
              "Return Ok(()) 用于 success cases"
            ]
          },
          "lesson-11-1-3": {
            ...
            "hints": [
              ...
              "用于 generate_with_lamports, use default values 用于 other fields",
              "Signer 账户 typically have is_writable set to true"
            ]
          },
          "lesson-11-1-4": {
            ...
            "duration": "45 min",
            "hints": [
              "Use builder pattern 使用 self return type 用于 chaining",
              "Push strings into vectors (use to_string() to convert &str)",
              "build() consumes self 和 creates the final TestScenario"
            ]
          }
        }
      },
      "mod-11-2": {
        ...
        "lessons": {
          ...
          "lesson-11-2-2": {
            ...
            "duration": "45 min",
            "hints": [
              "Use wrapping_mul 和 wrapping_add 用于 LCG to avoid overflow panics",
              "Generate bytes by taking random % 256",
              "用于 bounded generation, calculate range 和 add to min"
            ]
          },
          "lesson-11-2-3": {
            ...
            "duration": "45 min",
            "hints": [
              "用于 commutative, call op both ways 和 compare",
              "用于 associative, nest the calls differently 和 compare",
              "用于 non_decreasing, iterate through pairs 和 check ordering"
            ]
          },
          "lesson-11-2-4": {
            ...
            "duration": "45 min",
            "hints": [
              "Use saturating_sub 和 saturating_add to avoid overflow",
        ...
        "lessons": {
          ...
          "lesson-12-1-2": {
            ...
            "hints": [
              ...
              "账户 access is simply 账户 multiplied by per-账户 CU",
          ...
          "lesson-12-1-4": {
            ...
            "duration": "45 min",
            "hints": [
              "Calculate available CUs after accounting 用于 overhead",
              "Use ceiling division: (n + d - 1) / d 用于 number of batches",
        ...
        "lessons": {
          ...
          "lesson-12-2-4": {
            ...
            "hints": [
              ...
              "用于 read_bytes, return a slice of the original data (zero-copy)",
        ...
        "lessons": {
          ...
          "lesson-13-1-2": {
            ...
            "hints": [
              ...
              "用于 linear vesting, use u128 用于 中级 calculation to avoid overflow",
          ...
          "lesson-13-1-3": {
            ...
            "hints": [
              ...
              "Use u128 用于 percentage calculation to avoid overflow",
          ...
          "lesson-13-1-4": {
            ...
            "hints": [
              ...
              "Use filter 和 sum to calculate total by timestamp",
              "用于 monthly, use 30 days * 24 hours * 60 minutes * 60 seconds"
            ]
          }
        }
      },
        ...
        "lessons": {
          ...
          "lesson-13-2-2": {
            ...
            "hints": [
              ...
              "用于 days to target, use logarithms to solve 用于 time"
            ]
          },
          "lesson-13-2-3": {
          ...
          "lesson-13-2-4": {
            ...
            "hints": [
              ...
              "Use u128 用于 中级 calculation to avoid overflow",
              "Proposal passes if quorum met 和 more 用于 than against"
            ]
          }
        }
      }
      ...
      "mod-14-1": {
        ...
        "lessons": {
          ...
          "lesson-14-1-2": {
            ...
            "duration": "45 min",
            "hints": [
              "Use u128 用于 中级 calculations to prevent overflow",
          ...
          "lesson-14-1-3": {
            ...
            "duration": "45 min",
            "hints": [
              "用于 first liquidity, use sqrt(a * b) as LP tokens",
        ...
        "lessons": {
          ...
          "lesson-14-2-3": {
            ...
            "hints": [
              ...
              "Use piecewise function 用于 borrow rate (below/above optimal)",
              "Supply rate 账户 用于 reserve factor taken by protocol"
            ]
          },
          "lesson-14-2-4": {
            ...
            "hints": [
              ...
              "Profit is gain minus fee (use i64 用于 signed result)"
            ]
          }
        }
      }
      ...
      "mod-15-1": {
        ...
        "lessons": {
          ...
          "lesson-15-1-2": {
            ...
            "duration": "45 min",
            "hints": [
              "Check string lengths 使用 len() method",
              "Sum creator shares 和 verify equals 100",
          ...
          "lesson-15-1-4": {
            ...
            "hints": [
              ...
              "Sort descending by score 用于 ranking (highest = rank 1)"
            ]
          }
        }
      },
      "mod-15-2": {
        ...
        "lessons": {
          ...
          "lesson-15-2-2": {
            ...
            "duration": "45 min",
            "hints": [
              "Soulbound tokens return false 用于 can_transfer",
              "Burn requires is_burnable 和 owner == burner",
          ...
          "lesson-15-2-4": {
            ...
            "duration": "45 min",
            "hints": [
              "Check available slots, compatibility, 和 not already equipped",
              "Use position() 和 remove() to unequip items",
      ...
      "mod-16-1": {
        ...
        "lessons": {
          ...
          "lesson-16-1-2": {
            ...
            "duration": "45 min",
            "hints": [
              "Check boolean flags 用于 signer 和 writable validation",
              "用于 balance, compare lamports against minimum required",
          ...
          "lesson-16-1-3": {
            ...
            "hints": [
              ...
              "Signature simulation combines message 和 seed hashes"
            ]
          },
          "lesson-16-1-4": {
            ...
            "hints": [
              ...
              "create_cpi_call combines route 使用 账户 preparation"
            ]
          }
        }
      },
      "mod-16-2": {
        ...
        "lessons": {
          ...
          "lesson-16-2-2": {
            ...
            "duration": "45 min",
            "hints": [
              "Validate that steps is not empty 和 minimum_output > 0",
          ...
          "lesson-16-2-3": {
            ...
            "duration": "45 min",
            "hints": [
              "Clone 账户 vector to create independent snapshot",
              "用于 no_changes, verify all changed 账户 are in except list",
              "Compare balance 和 data_hash to detect changes"
            ]
          },
          "lesson-16-2-4": {
            ...
            "hints": [
              ...
              "Use find() to locate permission 用于 program_id",
      ...
      "mod-17-1": {
        ...
        "lessons": {
          ...
          "lesson-17-1-2": {
            ...
            "duration": "45 min",
            "hints": [
              "Compare all pairs of DEX prices 用于 same token pair",
          ...
          "lesson-17-1-3": {
            ...
            "hints": [
              ...
              "Calculate collateral value using price (使用 6 decimals)",
          ...
          "lesson-17-1-4": {
            ...
            "hints": [
              ...
              "Total cost includes priority fee, base, 和 compute unit cost"
            ]
          }
        }
      },
        ...
        "lessons": {
          ...
          "lesson-17-2-2": {
            ...
            "hints": [
              ...
              "Sort by priority fee descending 用于 optimal ordering"
            ]
          },
          "lesson-17-2-3": {
            ...
            "duration": "45 min",
            "hints": [
              "Use constant product formula 使用 fee 用于 output calculation",
          ...
          "lesson-17-2-4": {
            ...
            "duration": "45 min",
            "hints": [
              "Apply slippage to both buy (increase) 和 sell (decrease) prices",
              "Risk score combines failure rate, profit negativity, 和 capital",
        ...
        "lessons": {
          ...
          "lesson-18-1-3": {
            ...
            "hints": [
              ...
              "Use ceiling division 用于 交易 count",
          ...
          "lesson-18-1-4": {
            ...
            "hints": [
              ...
              "Use find_mut to locate 和 modify program metadata"
            ]
          }
        }
      },
        ...
        "lessons": {
          ...
          "lesson-18-2-2": {
            ...
            "hints": [
              ...
              "Use any() 使用 matches! to check 用于 required stages",
          ...
          "lesson-18-2-3": {
            ...
            "duration": "45 min",
            "hints": [
              "Split version string by '.' 和 parse each component",
          ...
          "lesson-18-2-4": {
            ...
            "duration": "45 min",
            "hints": [
              "Push 部署 和 update current_index to new 部署",
              "can_rollback checks 用于 any successful 部署 before current",
              "get_rollback_target finds most recent successful 部署"
            ]
          }
        }
      }
        ...
        "lessons": {
          ...
          "lesson-43-1-2": {
            ...
            "hints": [
              ...
              "Use to_be_bytes() 用于 big-endian byte conversion",
      ...
      "mod-43-2": {
        ...
        "lessons": {
          ...
          "lesson-43-2-2": {
            ...
            "duration": "45 min",
            "hints": [
              "Push lock to vector 和 return index as lock_id",
              "Verify requester matches owner before unlocking",
              "Use filter 和 sum to calculate owner's locked amount"
            ]
          },
          "lesson-43-2-3": {
            ...
            "duration": "45 min",
            "hints": [
              "Push token to vector 和 return index",
              "Check bounds before minting/burning",
              "Use get() 和 map() to safely retrieve supply"
            ]
          },
          "lesson-43-2-4": {
        ...
        "lessons": {
          ...
          "lesson-44-1-2": {
            ...
            "hints": [
              ...
              "Use matches! 用于 enum variant checking"
            ]
          },
          "lesson-44-1-3": {
            ...
            "duration": "45 min",
            "hints": [
              "Calculate decimal difference 和 scale accordingly",
              "Use u128 用于 中级 to prevent overflow",
              "Buy price increases, sell price decreases 使用 spread"
            ]
          },
          "lesson-44-1-4": {
      ...
      "mod-44-2": {
        ...
        "lessons": {
          ...
          "lesson-44-2-2": {
            ...
            "duration": "45 min",
            "hints": [
              "Sort prices 和 find middle element(s) 用于 median",
              "用于 weighted median, accumulate weights until reaching 50%",
          ...
          "lesson-44-2-3": {
            ...
            "hints": [
              ...
              "Find a price that at least 50% of oracles agree 使用",
      ...
      "mod-45-1": {
        ...
        "lessons": {
          ...
          "lesson-45-1-2": {
            ...
            "duration": "45 min",
            "hints": [
              "Match on (current, new) state pairs 用于 valid transitions",
              "Voting active only during time window in Active state",
              "Quorum 和 threshold use basis point calculations"
            ]
          },
          "lesson-45-1-3": {
            "title": "Voting Power Calculator Challenge",
          ...
          "lesson-45-1-4": {
            ...
            "hints": [
              ...
              "Use position() 和 remove() to undelegate",
              "Filter 和 sum to get delegated amount"
            ]
          }
        }
      },
      "mod-45-2": {
        ...
        "lessons": {
          ...
          "lesson-45-2-2": {
            ...
            "duration": "45 min",
            "hints": [
              "Check balance 和 category limits before allowing spend",
          ...
          "lesson-45-2-3": {
            ...
            "duration": "45 min",
            "hints": [
              "Push operation 和 return index as ID",
              "Can execute only if ETA reached 和 not executed",
          ...
          "lesson-45-2-4": {
            ...
            "duration": "45 min",
            "hints": [
              "Push action 和 return index as ID",
      ...
      "mod-46-1": {
        ...
        "lessons": {
          ...
          "lesson-46-1-2": {
            ...
            "duration": "45 min",
            "hints": [
              "Check player matches, state is waiting, 和 before deadline",
              "Turn complete when all players submitted",
              "Increment turn number 用于 next turn"
            ]
          },
          "lesson-46-1-3": {
        ...
        "lessons": {
          ...
          "lesson-46-2-2": {
            ...
            "hints": [
              ...
              "XOR all revealed values 用于 combined randomness"
            ]
          },
          "lesson-46-2-3": {
            ...
            "duration": "45 min",
            "hints": [
              "Use hash of seed 用于 deterministic randomness",
              "Modulo operation gives range, add 1 用于 1-based",
      ...
      "mod-47-1": {
        ...
        "lessons": {
          ...
          "lesson-47-1-2": {
            ...
            "duration": "45 min",
            "hints": [
              "Check exact length 和 all characters valid",
              "base64url uses alphanumeric plus - 和 _"
            ]
          },
          "lesson-47-1-3": {
        ...
        "lessons": {
          ...
          "lesson-48-1-2": {
            ...
            "hints": [
              ...
              "Divide annual by epochs per year 用于 epoch reward",
          ...
          "lesson-48-1-3": {
            ...
            "hints": [
              ...
              "Sort by score descending 和 take top N",
              "Check each 验证者's percentage of total stake"
            ]
          },
          "lesson-48-1-4": {
            ...
            "hints": [
              ...
              "Count allocations that differ between old 和 new",
        ...
        "lessons": {
          ...
          "lesson-48-2-3": {
            ...
            "hints": [
              ...
              "Epoch 用于 slot is integer division"
            ]
          },
          "lesson-48-2-4": {
        ...
        "lessons": {
          ...
          "lesson-49-1-2": {
            ...
            "hints": [
              ...
              "Can sign if owner 和 not already signed 和 not executed",
              "Can execute if threshold reached 和 not executed"
            ]
          },
          "lesson-49-1-3": {
            ...
            "hints": [
              ...
              "Require threshold 和 delay 用于 execution"
            ]
          },
          "lesson-49-1-4": {
            ...
            "hints": [
              ...
              "Can execute if valid, allowed operation, 和 within limit",
        ...
        "lessons": {
          ...
          "lesson-49-2-3": {
            ...
            "hints": [
              ...
              "Validate all destinations in 交易"
            ]
          },
          "lesson-49-2-4": {
            ...
            "duration": "45 min",
            "hints": [
              "Handle wrap-around 用于 hours crossing midnight",
              "Check elapsed is between min 和 max delay",
              "Validate hours are 0-23 和 min <= max"
            ]
          }
        }
      }
        ...
        "lessons": {
          ...
          "lesson-50-1-2": {
            ...
            "hints": [
              ...
              "Combine seeds, program_id, 和 bump in hash",
          ...
          "lesson-50-1-3": {
            ...
            "duration": "45 min",
            "hints": [
              "Use byte string literals b\"...\" 用于 static prefixes",
              "Convert integers 使用 to_le_bytes()",
          ...
          "lesson-50-1-4": {
            ...
            "duration": "45 min",
            "hints": [
              "Compare stored seeds 使用 expected seeds",
              "Signer seeds include all seeds plus bump",
              "Canonical bump is from find_pda 使用 highest valid bump"
            ]
          }
        }
      },
        ...
        "lessons": {
          ...
          "lesson-50-2-2": {
            ...
            "hints": [
              ...
              "Use index bytes 用于 sibling derivation",
              "Verify by re-deriving 和 comparing"
            ]
          },
          "lesson-50-2-3": {
            ...
            "hints": [
              ...
              "Use counter in seeds 用于 uniqueness",
          ...
          "lesson-50-2-4": {
            ...
            "hints": [
              ...
              "Collision risk if same structure 和 component sizes"
            ]
          }
        }
      }
      ...
      "mod-51-1": {
        ...
        "lessons": {
          ...
          "lesson-51-1-2": {
            ...
            "duration": "45 min",
            "hints": [
              "Use powi 用于 disinflation calculation",
          ...
          "lesson-51-1-3": {
            ...
            "duration": "45 min",
            "hints": [
              "Priority multiplier increases 使用 priority level",
        ...
        "lessons": {
          ...
          "lesson-51-2-4": {
            ...
            "hints": [
              ...
              "Score combines burn ratio 和 staking ratio"
            ]
          }
        }
      }
